...
class class_parse(object):
    def __init__(self):
        self.opt="/root/hmrishav/DAN/codes/config/DANv2/options/setting1/train/train_setting1_x2.yml"
        self.launcher="none"
        self.local_rank=0
...
def main():
    ...
    args = class_parse()#parser.parse_args()
    ...
    print("Print Frequency {}".format(opt["logger"]["print_freq"]))
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt["logger"]["print_freq"] == 0:
                ...
                smaller=min(len(train_loader),total_iters)
                
                print("Epoch {} Iter {}/{}".format(epoch,current_step%(smaller+1),smaller))
                if rank == 0:
                    print(message)
